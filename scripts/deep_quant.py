...
def get_configs():
    ...
    configs.DEFINE_float("outlier_window_mean", 1, "Window for rolling calculations for outliers")
    configs.DEFINE_float("outlier_window_std", 2, "Window for rolling calculations for outliers")
